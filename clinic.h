...
Email      : vade-lima-ramos@mysneca.ca
Section    : NAA
...
#define PHONE_LEN 10
#define MAX_CONCAT_STR_LEN 12
#define MAX_DAILY_APPOINTS 9
#define OPENING_HOUR 10
#define CLOSING_HOUR 14
#define INTRELVAL_APPOINT 30
...
// Todo:
void removeAppointment(struct Appointment *appt, int maxAppnt, struct Patient *ptn, int maxPatn);
//////////////////////////////////////
// UTILITY FUNCTIONS
//////////////////////////////////////
...
int timeSlotValidation(struct Appointment appointments[], struct Date date, struct Time time, int maxApp);
